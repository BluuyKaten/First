...
import com.gzlg.ui.domain.User;
import com.gzlg.ui.Util.CodeUtil;
...
public class LoginJFrame extends JFrame implements MouseListener {
    ...
    public void initView(){
        //1.添加用户名文字
        JLabel usernameTest = new JLabel(new ImageIcon("puzzlegame\\image\\login\\用户名.png"));
        usernameTest.setBounds(116,117,47,17);
        ...
        //3.添加密码文字
        JLabel passwordTest = new JLabel(new ImageIcon("puzzlegame\\image\\login\\密码.png"));
